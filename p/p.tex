...
\begin{lstlisting}
    ...
    #include <map>
    #include "hint.hpp"
    // Please import header https://github.com/With-Sky/HyperInt/blob/main/hint.hpp to the same directory to run this code
...
\begin{thebibliography}{99}
    ...
    \bibitem{Github} With-Sky. HyperInt (Github Repository). \href{https://github.com/With-Sky/HyperInt}{https://github.com/With-Sky/HyperInt}. [Online; accessed 13-April-2023]
    \end{thebibliography}
    \endgroup
